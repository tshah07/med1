    ...
    <div class="container-fluid">
      ...
      <ul class='main-nav'>
        ...
        <li>
          ...
          <ul class="dropdown-menu">
            <li>
              <a href="<?= Uri::base()?>appointments">Show All</a>
            </li>
            <li>
              <a href="<?= Uri::base()?>appointments/create">New Appointment</a>
            </li>
            <li>
      ...
      <div class="user">
        <ul class="icon-nav">
          <li class='dropdown'>
            ...
            <ul class="dropdown-menu pull-right message-ul">
              <li>
                <a href="#">
                  <img src="<?php echo Uri::base();?>img/demo/user-1.jpg" alt="">
                  <div class="details">
              ...
              <li>
                <a href="#">
                  <img src="<?php echo Uri::base();?>img/demo/user-2.jpg" alt="">
                  <div class="details">
              ...
              <li>
                <a href="#">
                  <img src="<?php echo Uri::base();?>img/demo/user-3.jpg" alt="">
                  <div class="details">
          ...
          <li class='dropdown language-select'>
            <a href="#" class='dropdown-toggle' data-toggle="dropdown"><img src="<?php echo Uri::base();?>img/demo/flags/us.gif" alt=""><span>US</span></a>
            <ul class="dropdown-menu pull-right">
              <li>
                <a href="#"><img src="<?php echo Uri::base();?>img/demo/flags/br.gif" alt=""><span>Brasil</span></a>
              </li>
              <li>
                <a href="#"><img src="<?php echo Uri::base();?>img/demo/flags/de.gif" alt=""><span>Deutschland</span></a>
              </li>
              <li>
                <a href="#"><img src="<?php echo Uri::base();?>img/demo/flags/es.gif" alt=""><span>España</span></a>
              </li>
              <li>
                <a href="#"><img src="<?php echo Uri::base();?>img/demo/flags/fr.gif" alt=""><span>France</span></a>
              </li>
            </ul>
          </li>
        </ul>
        <div class="dropdown">
          ...
          <img src="<?php echo Uri::base();?>img/demo/user-avatar.jpg" alt=""></a>
          <ul class="dropdown-menu pull-right">
            <li>
            ...
            <li>
              <a href="<?= Uri::base()?>login/logout">Sign out</a>
            </li>
          </ul>
        </div>
      </div>
