					...
					<div class="box box-color box-bordered">
						...
						<div class="box-content nopadding">
							<ul class="tabs tabs-inline tabs-top">
								...
								<li>
									<a href="<?php echo Uri::create('patient/index');?>" data-target="#tabone" data-toggle='tab'><i class="icon-bullhorn"></i> Notifications</a>
								</li>
								<li>
                            ...
                            <div class="tab-pane" id="tabone">My Tab</div>
								<div class="tab-pane active" id="profile">
									<form action="#" class="form-horizontal">
										<div class="row-fluid">
											<div class="span2">
												<div class="fileupload fileupload-new" data-provides="fileupload">
													<div class="fileupload-new thumbnail" style="max-width: 200px; max-height: 150px;"><img src="<?php echo Uri::base();?>img/demo/user-1.jpg" /></div>
